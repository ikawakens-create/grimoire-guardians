...
export const WORLDS = [
  ...
  // m2_04c: M2-04c 3桁のたしざん（B+Cモード）
  {
    ...
    zone: 'zone1',
    title: '3桁の たしざん',
    description: '3桁の ひっさんで たしざんを といてみよう！',
    difficulty: 4,
    dropRateMultiplier: 0.55,
    totalQuestions: 15,
    assets: {
      icon: 'assets/icons/worlds/m2_04c.png',
      iconLocked: 'assets/icons/worlds/m2_04c_locked.png'
    },
    theme: { gradient: 'linear-gradient(135deg, #11998E, #38EF7D)' },
    order: 42,
    freeToPlay: false,
  ...
  // m2_04d: M2-04d 3桁のひきざん（B+Cモード）
  {
    ...
    zone: 'zone1',
    title: '3桁の ひきざん',
    description: '3桁の ひっさんで ひきざんを といてみよう！',
    difficulty: 4,
    dropRateMultiplier: 0.55,
    totalQuestions: 15,
    assets: {
      icon: 'assets/icons/worlds/m2_04d.png',
      iconLocked: 'assets/icons/worlds/m2_04d_locked.png'
    },
    theme: { gradient: 'linear-gradient(135deg, #e84393, #d63031)' },
    order: 43,
    freeToPlay: false,
  ...
  // m2_04e: M2-04e 3桁のひっさんまとめ
  {
    ...
    zone: 'zone1',
    title: '3桁の ひっさん まとめ',
    description: 'たし・ひきざんを まとめて チャレンジ！',
    difficulty: 4,
    dropRateMultiplier: 0.55,
    totalQuestions: 15,
    assets: {
      icon: 'assets/icons/worlds/m2_04e.png',
      iconLocked: 'assets/icons/worlds/m2_04e_locked.png'
    },
    theme: { gradient: 'linear-gradient(135deg, #36D1DC, #5B86E5)' },
    order: 44,
    freeToPlay: false,
