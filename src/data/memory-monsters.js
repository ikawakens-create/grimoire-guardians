...
export const MONSTERS = [
  ...
  },
  {
    ...
    layer: 1,
    rarity: 'common',
    flavorText: '10本の足でリズムよく跳ねるバッタ竜。10の数字をカリカリ解く。',
  },
  {
    id: 'mon_08',
    name: 'トーテン',
  ...
  },
  {
    ...
    layer: 2,
    rarity: 'uncommon',
    flavorText: '素数の地点だけを踏んで歩く石鎧の番人。2・3・5・7の刻印が体に鈍く光る。',
  },
  {
    id: 'mon_13',
    name: 'サクランボン',
  ...
  },
  {
    ...
    layer: 3,
    rarity: 'rare',
    flavorText: '甲羅に精密な歯車が埋め込まれた機械式カニ竜。5分単位の時計術を極め、3方向に光線を放つ。',
  },
  {
    id: 'mon_23',
    name: 'ジュウハチライオン',
  ...
  },
  {
    ...
    layer: 3,
    rarity: 'rare',
    flavorText: '鎧をまとった古代象の戦士。引き算の文章題を体で感じ取り、一撃で正解を叩き出す沈黙の猛者。',
  },
  {
    id: 'mon_30',
    name: '（仮）クロノリュウ',
  ...
  },
  {
    ...
    layer: 4,
    rarity: 'legendary',
    flavorText: 'きおくのいせきを築いた古代王の亡霊。王冠は∞・Σ・πで構成され、半透明の霊体に古代数式が絶えず漂う。',
  },
  {
    id: 'mon_37',
    name: 'カルキュロン',
