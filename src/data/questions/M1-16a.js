 ...
 *
 * Step構成（シャッフル出題）
 *   Step1: あわせていくつ（小さい数）（プール11問 → 5問出題）
 *   Step2: ふえると いくつ（プール11問 → 5問出題）
 *   Step3: 100まで の たしざん 文章題（プール10問 → 5問出題）
 *
 * @version 2.1
 * @date 2026-03-15
 */
...
const questions = [
  ...
  },
  {
    ...
    type: 'choice',
    question: '🚗 赤いくるまが 4だい、\n🚕 きいろいくるまが 9だい います。\nあわせて なんだい？',
    choices: ['11だい', '12だい', '13だい', '14だい'],
    correctAnswer: '13だい',
    explanation: '4 + 9 = 13。「あわせて」はたし算！'
  },
  {
    id: 'M1-16a-Q24',
    unitId: 'M1-16a',
    ...
    type: 'choice',
    question: '🐟 金魚が 13びき、\n🐠 めだかが 5ひき います。\nあわせて なんびき？',
    choices: ['16びき', '17びき', '18びき', '19びき'],
    correctAnswer: '18びき',
    explanation: '13 + 5 = 18。「あわせて」はたし算！'
  },
  {
    id: 'M1-16a-Q25',
    unitId: 'M1-16a',
    ...
    correctAnswer: '15こ',
    explanation: '9 + 6 = 15。「あわせて」はたし算！'
  },

  // =====================================================
  // Step2: ふえると いくつ（プール11問）
  // =====================================================
  {
    id: 'M1-16a-Q06',
    unitId: 'M1-16a',
  ...
  },
  {
    ...
    step: 2,
    type: 'choice',
    question: 'かごに みかんが 13こ あります。\n4こ もらいました。\nぜんぶで なんこ？',
    choices: ['15こ', '16こ', '17こ', '18こ'],
    correctAnswer: '17こ',
    explanation: '13 + 4 = 17。「もらった」のでたし算！'
  },
  {
    id: 'M1-16a-Q27',
    unitId: 'M1-16a',
    step: 2,
    type: 'choice',
    question: 'いけに かめが 7ひき います。\n9ひき ふえました。\nなんびきに なりましたか？',
    choices: ['14びき', '15びき', '16びき', '17びき'],
    correctAnswer: '16びき',
    explanation: '7 + 9 = 16。「ふえた」のでたし算！'
  },
  {
    id: 'M1-16a-Q28',
    unitId: 'M1-16a',
    step: 2,
    type: 'choice',
    question: 'ふうせんが 11こ あります。\n5こ もらいました。\nぜんぶで なんこ？',
    choices: ['14こ', '15こ', '16こ', '17こ'],
    correctAnswer: '16こ',
    explanation: '11 + 5 = 16。「もらった」のでたし算！'
  },
  {
    id: 'M1-16a-Q29',
    unitId: 'M1-16a',
    step: 2,
    type: 'choice',
    question: 'ちゅうしゃじょうに くるまが 19だい あります。\n3だい はいってきました。\nなんだいに なりましたか？',
    choices: ['20だい', '21だい', '22だい', '23だい'],
    correctAnswer: '22だい',
    explanation: '19 + 3 = 22。「はいってきた」のでたし算！'
  },

  // =====================================================
  // Step3: 100まで の たしざん 文章題（プール10問）
  // =====================================================
  {
    id: 'M1-16a-Q11',
    unitId: 'M1-16a',
  ...
  },
  {
    ...
    step: 3,
    type: 'choice',
    question: 'みかんが 30こ、りんごが 40こ あります。\nあわせて なんこ？',
    choices: ['60こ', '65こ', '70こ', '75こ'],
    correctAnswer: '70こ',
  ...
  },
  {
    ...
    step: 3,
    type: 'choice',
    question: 'こうえんに 人が 64にん います。\n5にん きました。\nぜんぶで なんにん？',
    choices: ['67にん', '68にん', '69にん', '70にん'],
    correctAnswer: '69にん',
    explanation: '64 + 5 = 69。いちのくらいだけ たせばOK！'
  },
  {
    id: 'M1-16a-Q32',
    unitId: 'M1-16a',
    step: 3,
    type: 'choice',
    question: 'えんぴつが 71ほん あります。\n20ほん もらいました。\nぜんぶで なんほん？',
    choices: ['81ほん', '88ほん', '89ほん', '91ほん'],
    correctAnswer: '91ほん',
    explanation: '71 + 20 = 91。じゅうのくらいだけ たせばOK！'
  }
];
