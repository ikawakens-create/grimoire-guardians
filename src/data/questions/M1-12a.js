 ...
 *
 * Step構成（シャッフル出題）
 *   Step1: 例題・2段階アニメ（プール7問 → 3問出題）
 *   Step2: 考え方・中間□ヒント（プール9問 → 4問出題）
 *   Step3: 問題・答え10以下（プール8問 → 3問出題）
 *   Step4: 問題・答え11〜15（プール6問 → 3問出題）
 *   Step5: くりあがりとの連携（プール6問 → 2問出題）
 *
 * ひらめきポイント:
...
const questions = [
  ...
  },
  {
    ...
    choices: ['8', '9', '10', '11'],
    correctAnswer: '10',
    explanation: '3 + 2 = 5、5 + 5 = 10。答えは10！'
  },
  ...
  },
  {
    ...
    choices: ['8', '9', '10', '11'],
    correctAnswer: '10',
    explanation: '5 + 3 = 8、8 + 2 = 10。答えは10！'
  },
  {
    id: 'M1-12a-Q29',
    unitId: 'M1-12a',
  ...
  },
  {
    ...
    choices: ['13', '14', '15', '16'],
    correctAnswer: '15',
    explanation: '9 + 4 = 13（繰り上がり！）、13 + 2 = 15。答えは15！'
  },
  {
    id: 'M1-12a-Q36',
    unitId: 'M1-12a',
    ...
    choices: ['13', '14', '15', '16'],
    correctAnswer: '15',
    explanation: '8 + 3 = 11（繰り上がり！）、11 + 4 = 15。答えは15！'
  }
];
