 ...
 *
 * Step構成（シャッフル出題）
 *   Step1: のこりは いくつ（小さい数）（プール11問 → 5問出題）
 *   Step2: ちがいは いくつ（プール11問 → 5問出題）
 *   Step3: 100まで の ひきざん 文章題（プール10問 → 5問出題）
 *
 * @version 2.1
 * @date 2026-03-15
 */
...
const questions = [
  ...
  },
  {
    ...
    step: 1,
    type: 'choice',
    question: 'ふうせんが 17こ あります。\n9こ とびました。のこりは なんこ？',
    choices: ['6こ', '7こ', '8こ', '9こ'],
    correctAnswer: '8こ',
    explanation: '17 - 9 = 8。「とんでいった」のでひき算！'
  },
  {
    id: 'M1-16b-Q23',
    unitId: 'M1-16b',
    step: 1,
    type: 'choice',
    question: 'あめが 16こ あります。\n7こ おともだちに あげました。\nのこりは なんこ？',
    choices: ['7こ', '8こ', '9こ', '10こ'],
    correctAnswer: '9こ',
    explanation: '16 - 7 = 9。「あげた」のでひき算！'
  },
  {
    id: 'M1-16b-Q24',
    unitId: 'M1-16b',
    step: 1,
    type: 'choice',
    question: '✏️ えんぴつが 11ほん あります。\n3ほん つかいました。のこりは なんほん？',
    choices: ['6ほん', '7ほん', '8ほん', '9ほん'],
    correctAnswer: '8ほん',
    explanation: '11 - 3 = 8。「つかった」のでひき算！'
  },
  {
    id: 'M1-16b-Q25',
    unitId: 'M1-16b',
    step: 1,
    type: 'choice',
    question: 'いけに さかなが 18ひき います。\n5ひき もってかえりました。\nのこりは なんびき？',
    choices: ['11びき', '12びき', '13びき', '14びき'],
    correctAnswer: '13びき',
    explanation: '18 - 5 = 13。「もってかえった」のでひき算！'
  },

  // =====================================================
  // Step2: ちがいは いくつ（プール11問）
  // =====================================================
  {
    id: 'M1-16b-Q06',
    unitId: 'M1-16b',
  ...
  },
  {
    ...
    step: 2,
    type: 'choice',
    question: '🍊 みかんが 14こ、🍋 レモンが 8こ あります。\nみかんは レモンより なんこ おおい？',
    choices: ['4こ', '5こ', '6こ', '7こ'],
    correctAnswer: '6こ',
    explanation: '14 - 8 = 6。「ちがい」をしらべるときはひき算！'
  },
  {
    id: 'M1-16b-Q27',
    unitId: 'M1-16b',
    step: 2,
    type: 'choice',
    question: 'たろうさんは 18まい、\nはなこさんは 7まい カードを もっています。\nちがいは なんまい？',
    choices: ['9まい', '10まい', '11まい', '12まい'],
    correctAnswer: '11まい',
    explanation: '18 - 7 = 11。「ちがい」はひき算で わかる！'
  },
  {
    id: 'M1-16b-Q28',
    unitId: 'M1-16b',
    step: 2,
    type: 'choice',
    question: '🚂 あかい でんしゃが 12りょう、\nあおい でんしゃが 5りょう あります。\nちがいは なんりょう？',
    choices: ['5りょう', '6りょう', '7りょう', '8りょう'],
    correctAnswer: '7りょう',
    explanation: '12 - 5 = 7。「ちがい」はひき算で わかる！'
  },
  {
    id: 'M1-16b-Q29',
    unitId: 'M1-16b',
    step: 2,
    type: 'choice',
    question: '男のこが 16にん、女のこが 9にん います。\nちがいは なんにん？',
    choices: ['5にん', '6にん', '7にん', '8にん'],
    correctAnswer: '7にん',
    explanation: '16 - 9 = 7。「ちがい」をしらべるときもひき算！'
  },

  // =====================================================
  // Step3: 100まで の ひきざん 文章題（プール10問）
  // =====================================================
  {
    id: 'M1-16b-Q11',
    unitId: 'M1-16b',
  ...
  },
  {
    ...
    step: 3,
    type: 'choice',
    question: 'えんぴつが 79ほん あります。\n6ほん くばりました。\nのこりは なんほん？',
    choices: ['71ほん', '72ほん', '73ほん', '74ほん'],
    correctAnswer: '73ほん',
    explanation: '79 - 6 = 73。いちのくらいだけ ひけばOK！'
  },
  {
    id: 'M1-16b-Q32',
    unitId: 'M1-16b',
    step: 3,
    type: 'choice',
    question: '🔴 赤いシールが 86まい、\n🔵 青いシールが 80まい あります。\nちがいは なんまい？',
    choices: ['4まい', '5まい', '6まい', '7まい'],
    correctAnswer: '6まい',
    explanation: '86 - 80 = 6。いちのくらいだけ ひけばOK！'
  }
];
