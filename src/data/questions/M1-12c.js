 ...
 *
 * Step構成（シャッフル出題）
 *   Step1: 例題・色分けアニメ（プール8問 → 3問出題）
 *   Step2: 考え方・中間□・記号確認（プール9問 → 4問出題）
 *   Step3: 問題・繰り上がり・繰り下がりなし（プール7問 → 3問出題）
 *   Step4: 問題・繰り上がり・繰り下がりあり（プール6問 → 3問出題）
 *   Step5: 文章題（プール6問 → 2問出題）
 *
 * ひらめきポイント:
 *   「記号が混ざっても、見た通りに左から！+なら足す、-なら引く、それだけ！」
 *
...
const questions = [
  ...
  },
  {
    ...
    choices: ['4', '5', '6', '7'],
    correctAnswer: '6',
    explanation: '4 + 8 = 12（繰り上がり！）、12 - 6 = 6。答えは6！'
  },
  {
    id: 'M1-12c-Q30',
    unitId: 'M1-12c',
    ...
    choices: ['7', '8', '9', '10'],
    correctAnswer: '9',
    explanation: '11 - 5 = 6（繰り下がり！）、6 + 3 = 9。答えは9！'
  },

  // =====================================================
  // Step3: 問題・繰り上がり・繰り下がりなし（7問）
  // =====================================================
  {
    id: 'M1-12c-Q08',
    unitId: 'M1-12c',
  ...
  },
  {
    ...
    step: 5,
    type: 'choice',
    question: 'とりが 10わ います。\n3わ とんでいって、7わ きました。\nなんわ？',
    choices: ['12', '13', '14', '15'],
    correctAnswer: '14',
    explanation: '10 - 3 = 7、7 + 7 = 14。14わです。'
  },
  {
    id: 'M1-12c-Q36',
    unitId: 'M1-12c',
    step: 5,
    type: 'choice',
    question: 'くりが 12こ あります。\n5こ たべて、4こ ひろいました。\nのこりは なんこ？',
    choices: ['9', '10', '11', '12'],
    correctAnswer: '11',
    explanation: '12 - 5 = 7（繰り下がり！）、7 + 4 = 11。のこりは11こです。'
  }
];
