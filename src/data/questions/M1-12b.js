 ...
 *
 * Step構成（シャッフル出題）
 *   Step1: 例題・2段階ブロックアニメ（プール7問 → 3問出題）
 *   Step2: 考え方・中間□ヒント（プール9問 → 4問出題）
 *   Step3: 問題・繰り下がりなし（プール8問 → 3問出題）
 *   Step4: 問題・繰り下がりあり（プール6問 → 3問出題）
...
const questions = [
  ...
  },
  {
    ...
    choices: ['0', '1', '2', '3'],
    correctAnswer: '0',
    explanation: '9 - 6 = 3、3 - 3 = 0。答えは0！れいでも正解！'
  },
  {
    id: 'M1-12b-Q28',
    unitId: 'M1-12b',
    ...
    choices: ['3', '4', '5', '6'],
    correctAnswer: '4',
    explanation: '11 - 4 = 7（繰り下がり！）、7 - 3 = 4。答えは4！'
  },
  {
    id: 'M1-12b-Q29',
    unitId: 'M1-12b',
    ...
    choices: ['0', '1', '2', '3'],
    correctAnswer: '0',
    explanation: '6 - 3 = 3、3 - 3 = 0。答えは0！れいでも正解！'
  },
  ...
  },
  {
    ...
    step: 5,
    type: 'choice',
    question: 'どんぐりが 8こ あります。\n2こ おちて、3こ なくなりました。\nのこりは なんこ？',
    choices: ['1', '2', '3', '4'],
    correctAnswer: '3',
    explanation: '8 - 2 = 6、6 - 3 = 3。のこりは3こです。'
  },
  {
    id: 'M1-12b-Q36',
    unitId: 'M1-12b',
    step: 5,
    type: 'choice',
    question: 'おかしが 12こ あります。\n4こ たべて、5こ くばりました。\nのこりは なんこ？',
    choices: ['2', '3', '4', '5'],
    correctAnswer: '3',
    explanation: '12 - 4 = 8（繰り下がり！）、8 - 5 = 3。のこりは3こです。'
  }
];
