 ...
 */
const KUKU_READINGS = {
  1: ['いちいちがいち', 'いちにがに',     'いちさんがさん', 'いちしがし',
      'いちごがご',     'いちろくがろく', 'いちしちがしち', 'いちはがは',
      'いちくがく'],
  2: ['にいちがに',     'ににんがし',     'にさんがろく',   'にしがはち',
      'にごじゅう',     'にろくじゅうに', 'にしちじゅうし', 'にはちじゅうろく',
      'にくじゅうはち'],
  3: ['さんいちがさん', 'さんにがろく',   'さざんがく',     'さんしじゅうに',
      'さんごじゅうご', 'さぶろくじゅうはち', 'さんしちにじゅういち', 'さんぱにじゅうし',
      'さんくにじゅうしち'],
  4: ['しいちがし',     'しにがはち',     'しさんじゅうに', 'ししじゅうろく',
      'しごにじゅう',   'しろくにじゅうし', 'ししちにじゅうはち', 'しはさんじゅうに',
      'しくさんじゅうろく'],
  5: ['ごいちがご',     'ごにじゅう',     'ごさんじゅうご', 'ごしにじゅう',
      'ごごにじゅうご', 'ごろくさんじゅう', 'ごしちさんじゅうご', 'ごはしじゅう',
      'ごくしじゅうご'],
  6: ['ろくいちがろく', 'ろくにじゅうに', 'ろくさんじゅうはち', 'ろくしにじゅうし',
      'ろくごさんじゅう', 'ろくろくさんじゅうろく', 'ろくしちしじゅうに', 'ろくはしじゅうはち',
      'ろくくごじゅうし'],
  7: ['しちいちがしち', 'しちにじゅうし', 'しちさんにじゅういち', 'しちしにじゅうはち',
      'しちごさんじゅうご', 'しちろくしじゅうに', 'しちしちしじゅうく', 'しちはごじゅうろく',
      'しちくろくじゅうさん'],
  8: ['はいちがは',     'はにじゅうろく', 'はさんにじゅうし',   'はしさんじゅうに',
      'はごしじゅう',   'はろくしじゅうはち', 'はしちごじゅうろく', 'ははろくじゅうし',
      'はくしちじゅうに'],
  9: ['くいちがく',     'くにじゅうはち', 'くさんにじゅうしち', 'くしさんじゅうろく',
      'くごしじゅうご', 'くろくごじゅうし', 'くしちろくじゅうさん', 'くはしちじゅうに',
      'くくはちじゅういち'],
};
...
class MultiTableScreen {
  ...
  _buildTableHTML(info) {
    return info.groups.map(({ dan, count }) => {
      const readings = KUKU_READINGS[dan] || [];
      const rows = Array.from({ length: count }, (_, i) => {
        ...
        return `
          <div class="multitable-row" data-row="${dan}-${n}">
            ...
            ${reading ? `<span class="multitable-reading">${reading}</span>` : ''}
          </div>`;
      });
